...
export const SIMULATORS = [
  ...
  { id: 22, name: '青椒生存', icon: 'ri-graduation-cap-line', color: '#6EE7B7', desc: '论文、基金、学生、家庭一起拉扯', scenarioId: 'qingjiao_sim' },
  { id: 23, name: '电竞经理', icon: 'ri-gamepad-line', color: '#A78BFA', desc: '战队磨合、舆论压力、版本窗口同场压来', scenarioId: 'esports_manager' },
  { id: 24, name: '创业转型', icon: 'ri-rocket-2-line', color: '#F97316', desc: '180 天内把故事跑成数据', scenarioId: 'startup_pivot' },
  { id: 25, name: '独立制片', icon: 'ri-movie-line', color: '#38BDF8', desc: '预算、剧组、成片质量一起搏命', scenarioId: 'film_production' },
  { id: 26, name: '灾后重建', icon: 'ri-building-4-line', color: '#4ADE80', desc: '救援之后，更难的是把秩序重新扶起来', scenarioId: 'disaster_rebuild' },
  { id: 27, name: '校园改革', icon: 'ri-community-line', color: '#FBBF24', desc: '改革方案、争议情绪、现实阻力同步推进', scenarioId: 'campus_governance' },
